...
- (BOOL) isTlsClientAuthKeyPurpose:(NSData *)certData;
- (BOOL) isESealType:(NSArray<NSString *> *)certPolicies;
- (BOOL) isMobileIdType:(NSArray<NSString *> *)certPolicies;
- (BOOL) isIdCardType:(NSArray<NSString *> *)certPolicies;
- (BOOL) isDigiIdType:(NSArray<NSString *> *)certPolicies;
- (BOOL) isUnknownType:(NSArray<NSString *> *)certPolicies;
@end
