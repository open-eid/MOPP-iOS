...
public class MoppLibSignature: NSObject {
    ...
    public var roleAndAddressData: MoppLibRoleAddressData = MoppLibRoleAddressData(roles: [], city: "", state: "", country: "", zip: "")
    ...
    public var signatureTimestampUTC: String = ""
    ...
    public var ocspTime: String = ""
    public var ocspTimeUTC: String = ""
    public var signersMobileTimeUTC: String = ""
}
