    ...
    func selectButton(buttonID: TokenFlowMethodButtonID) {
        tokenFlowMethodButtons.forEach {
            ...
            if id == buttonID {
                ...
                $0.titleLabel?.font = UIFont.setCustomFont(font: .allCapsBold, isNonDefaultPreferredContentSizeCategoryBigger() ? 14 : nil, .body)
                $0.isSelected = true
            } else {
                ...
                $0.titleLabel?.font = UIFont.setCustomFont(font: .allCapsRegular, isNonDefaultPreferredContentSizeCategoryBigger() ? 14 : nil, .body)
                $0.isSelected = false
            }
        }
    }
