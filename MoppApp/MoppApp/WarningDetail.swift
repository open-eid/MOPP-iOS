...
struct WarningDetail {
    ...
    init() {
        self.warningHeader = nil
        self.warningDescription = nil
        self.warningDetails = nil
    }
    
    init(warningHeader: String, warningDescription: String) {
        self.warningHeader = warningHeader
        self.warningDescription = warningDescription
        self.warningDetails = nil
    }
    
    init(warningHeader: String, warningDescription: String, warningDetails: String) {
        self.warningHeader = warningHeader
        self.warningDescription = warningDescription
